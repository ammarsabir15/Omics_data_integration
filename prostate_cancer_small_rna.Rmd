...
# reading input files
```{r}
design_table <- read.table ("/mnt/acri7/ssrivastava/Prostate_EV_comboseq_2022/derfinder_prostate/designv4.txt",header = T, row.names=1)

head(design_table)

derf_output <- read.table("/mnt/acri7/ssrivastava/Prostate_EV_comboseq_2022/derfinder_prostate/Differential_expressed.v3.3.tab", header=T)
...
# loading the data
load("/mnt/acri7/ssrivastava/Prostate_EV_comboseq_2022/EXCERPT_PIPELINE/excerpt_out/exceRpt_smallRNAQuants_ReadCounts.RData")
